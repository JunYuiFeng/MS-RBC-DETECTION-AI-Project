...
const calculatePercentageDifferences = () => {
    ...
    const totalDeformedA = patient1.deformedCellsDetected + patient1.healthyCellsDetected;
    const totalDeformedB = patient2.deformedCellsDetected + patient2.healthyCellsDetected;

    deformedCellsPercentageDifference.value = parseFloat(((patient1.deformedCellsDetected - patient2.deformedCellsDetected) / totalDeformedA * 100).toFixed(2));
    healthyCellsPercentageDifference.value = parseFloat(((patient1.healthyCellsDetected - patient2.healthyCellsDetected) / totalDeformedB * 100).toFixed(2));
};
